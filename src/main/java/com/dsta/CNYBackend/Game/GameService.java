...
public class GameService {
    ...
    public void resetGame() {
        ...
        Query q3 = this.em.createQuery("DELETE FROM PollChoice p");
        Query q4 = this.em.createQuery("DELETE FROM Poll p");
        Query q5 = this.em.createQuery("DELETE FROM User u WHERE u.username!='admin'");
